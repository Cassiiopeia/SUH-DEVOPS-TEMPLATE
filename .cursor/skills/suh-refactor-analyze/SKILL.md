---
name: suh-refactor-analyze
description: "Refactor Analyze Mode (Plan Only) - 리팩토링 분석 전문가. Code Smell을 탐지하고 리팩토링 계획을 수립한다. 코드는 절대 수정하지 않는다. 리팩토링 전 분석이 필요할 때 사용. /suh-refactor-analyze 호출 시 사용. /refactor는 실제 리팩토링을 진행하는 별도 명령어."
---
