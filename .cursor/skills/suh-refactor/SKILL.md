---
name: suh-refactor
description: "Refactor Mode - 리팩토링 전문가. 코드의 외부 동작은 유지하면서 내부 구조를 개선한다. Extract Method, DRY, Guard Clauses 등 리팩토링 기법을 적용할 때 사용. /suh-refactor 호출 시 사용. 분석만 필요하면 /refactor-analyze를 사용."
---
