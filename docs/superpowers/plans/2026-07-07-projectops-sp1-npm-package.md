...
**GitHub 이슈:** https://github.com/Cassiiopeia/SUH-DEVOPS-TEMPLATE/issues/424
...
- 커밋 메시지 형식(이모지·태그 금지, AI 흔적 trailer 절대 금지):
  `projectops npx CLI 전환 및 npm 배포 자동화 : feat : {설명} https://github.com/Cassiiopeia/SUH-DEVOPS-TEMPLATE/issues/424`
...
```json
{
  ...
  "repository": {
    "type": "git",
    "url": "git+https://github.com/Cassiiopeia/SUH-DEVOPS-TEMPLATE.git"
  },
  "bugs": {
    "url": "https://github.com/Cassiiopeia/SUH-DEVOPS-TEMPLATE/issues"
  },
  "type": "module",
  "bin": {
...
git commit -m "projectops npx CLI 전환 및 npm 배포 자동화 : feat : package.json을 projectops npm 매니페스트로 전환하고 스텁 CLI 추가 https://github.com/Cassiiopeia/SUH-DEVOPS-TEMPLATE/issues/424"
```
...
git commit -m "projectops npx CLI 전환 및 npm 배포 자동화 : feat : CLI 전용 파일(bin·src·NPM-PUBLISH)을 initializer·integrator 3곳 제외 목록에 반영 https://github.com/Cassiiopeia/SUH-DEVOPS-TEMPLATE/issues/424"
```
...
git commit -m "projectops npx CLI 전환 및 npm 배포 자동화 : feat : deploy 트리거 npm 자동배포 워크플로우 신설(멱등 publish) https://github.com/Cassiiopeia/SUH-DEVOPS-TEMPLATE/issues/424"
```
...
GitHub API(`POST /repos/Cassiiopeia/SUH-DEVOPS-TEMPLATE/actions/workflows/PROJECT-TEMPLATE-NPM-PUBLISH.yaml/dispatches`, body `{"ref":"main"}`) 또는 Actions 탭에서 수동 실행.
