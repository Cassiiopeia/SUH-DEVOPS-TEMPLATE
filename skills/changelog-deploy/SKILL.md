...
SCRIPTS=$(ls -d ~/.claude/plugins/cache/*/projectops/*/skills/changelog-deploy/scripts 2>/dev/null | sort -V | tail -1); [ -z "$SCRIPTS" ] && SCRIPTS="$(git rev-parse --show-toplevel)/skills/changelog-deploy/scripts"
