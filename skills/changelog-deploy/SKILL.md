...
SCRIPTS=$(ls -d ~/.claude/plugins/cache/*/projectops/*/skills/changelog-deploy/scripts 2>/dev/null | sort -V | tail -1); [ -z "$SCRIPTS" ] && SCRIPTS="$PROJECT_ROOT/skills/changelog-deploy/scripts"; cd "$SCRIPTS" || exit 1
