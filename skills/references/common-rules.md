...
| skill | py 파일 |
|---|---|
| github | `skills/github/scripts/github_cli.py` |
| issue | `skills/issue/scripts/issue_cli.py` |
| commit | `skills/commit/scripts/commit_cli.py` |
...
| changelog-deploy | `skills/changelog-deploy/scripts/changelog_cli.py` |
