#!/usr/bin/env python3
"""troubleshoot_cli — suh-troubleshoot skill 전용 CLI.
...
def build_parser() -> JSONArgumentParser:
    parser = JSONArgumentParser(prog="troubleshoot_cli", description="suh-troubleshoot skill CLI")
    sub = parser.add_subparsers(dest="command", required=True)

    p_gop = sub.add_parser("get-output-path", help="트러블슈팅 보고서 출력 경로")
