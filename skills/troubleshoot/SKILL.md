...
SCRIPTS=$(ls -d ~/.claude/plugins/cache/*/projectops/*/skills/troubleshoot/scripts 2>/dev/null | sort -V | tail -1); [ -z "$SCRIPTS" ] && SCRIPTS="$PROJECT_ROOT/skills/troubleshoot/scripts"; cd "$SCRIPTS" || exit 1
